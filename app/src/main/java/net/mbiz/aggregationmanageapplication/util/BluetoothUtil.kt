...
import net.mbiz.aggregationmanageapplication.data.Constants.Companion.CHARACTERISTIC_COMMAND_STRING
import net.mbiz.aggregationmanageapplication.data.Constants.Companion.CHARACTERISTIC_RESPONSE_STRING
import net.mbiz.aggregationmanageapplication.data.Constants.Companion.SERVICE_STRING
import java.util.*
